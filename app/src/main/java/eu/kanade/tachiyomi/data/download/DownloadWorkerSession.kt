...
/**
 * Which [DownloadJob] run owns the downloader. A replaced or stopped run can still be winding down, and it must not
 * pause or stop the downloader the run after it has started.
 */
