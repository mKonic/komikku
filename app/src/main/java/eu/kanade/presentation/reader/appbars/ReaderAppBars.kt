...
fun ReaderAppBars(
    ...
    // KMK --> The WebGPU renderer carries its own direction rather than having a right-to-left
    // subclass, so the seek bar has to ask it instead of matching on the viewer type.
